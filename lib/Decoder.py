...
class token_trans(nn.Module):
    ...
    def forward(self, fea, saliency_tokens, contour_tokens, num):
        B, _, _ = fea.shape
        # fea [B, H*W, 64]
        # project to 384 dim
        ...
        fea,saliency_tokens,contour_tokens,fea_tmp, fea_s = self.encoderlayer(fea, num)
...
class Decoder(nn.Module):
    def __init__(self, embed_dim=384, token_dim=64, depth=2, img_size=224):
        ...
        # self.enc_dim_8 = nn.Linear(128, token_dim)
        # self.enc_dim_4 = nn.Linear(128, token_dim)
    ...
    def forward(self, fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_16, contour_tokens_16, saliency_fea_1_16, contour_fea_1_16, rgb_fea_1_8, rgb_fea_1_4,num):
        ...
        fea_1_8, saliency_tokens, contour_tokens, fea_8, saliency_tokens_8, contour_tokens_8,  saliency_fea_1_8, contour_fea_1_8 = self.token_pre_1_8(fea_1_8, saliency_tokens, contour_tokens, num)
        ...
        fea_1_4, saliency_tokens, contour_tokens, fea_4, saliency_tokens_4, contour_tokens_4,saliency_fea_1_4, contour_fea_1_4  = self.token_pre_1_4(fea_1_4, saliency_tokens, contour_tokens, num)
