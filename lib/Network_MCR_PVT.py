...
class Network(nn.Module):
    def __init__(self, args,channels=128,A=256, B=96, C=96, D=32, FF=16,G=16,P=4,feature_size=26):
        super(Network, self).__init__()
        self.shared_encoder = pvt_v2_b4()
        pretrained_dict = torch.load('/data/clb/Revised_MCRNet/pvt_v2_b4.pth')
        ...
        self.mlp_8_2_try1 = nn.Sequential(
            ...
            nn.GELU(),
            nn.Linear(args.encoder_dim[1], args.encoder_dim[1]),)
        self.transformer_1 = Transformer(embed_dim=args.encoder_dim[1], depth=2, num_heads=3, mlp_ratio=3.)
