...
class Network(nn.Module):
    def __init__(self, args,channels=128,A=256, B=32, C=32, D=32, FF=16,G=16,P=4,feature_size=22):
        ...
        self.shared_encoder = swin_transformer(pretrained=True, args=args)
    ...
    def forward(self, x, depth_Input):
        image = x

        rgb_fea_1_4 , rgb_fea_1_8, rgb_fea_1_16, rgb_fea_1_32 = self.shared_encoder(x, [1,1,5,10])
